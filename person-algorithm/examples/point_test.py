...
def vis_3d_multiple_skeleton_conf_whole_toimage_withoutp(kpt_3d, point_p_pred,
                                                conf_thres=0.2, filename=None):
    fig = plt.figure(figsize=(12, 10), dpi=72)
...
for ids in images_ids:
    ...
    if len(output)!=0:
        ...
        #                                                        conf_thres=-0.1,
        #                                                        filename='output_pose_3d (x,y,z: camera-centered. mm.)')
        td_image = vis_3d_multiple_skeleton_conf_whole_toimage_withoutp(kp_3d, cup_pred,
                                                                        conf_thres=-0.1,
                                                                        filename='output_pose_3d (x,y,z: camera-centered. mm.)')
