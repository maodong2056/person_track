...
import datetime
import numpy as np
from src import DeepDetModel, Video, RealSenceVideo
...
video_name = "../user/output/3dpose_point_res_{}_{}_{}_{}.avi".format(i.year, i.month, i.day, i.hour)
...
while ret:
    ...
    if len(output)!=0:
        ...
        moving_dist, moving_direction = disAndAngle(p_center_z, p_camera_z, p_hand_z, radius_, root_dis, bias=-300)
        ...
        cv2.ellipse(frame, (int(cup_pred_2d[0][0]), int(cup_pred_2d[0][1])), (20, 10), 0, 0, 360, (0, 0, 255),
                    thickness=5)
