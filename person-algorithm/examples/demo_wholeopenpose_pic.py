...
import glob
import numpy as np
from src import DeepDetModel, DeepDetModelWhole, DeepDetModelOpenPose, Video
...
# det&track algorithm#######################################################################
my_trackModule = DeepDetModelOpenPose(**config["deepModel"]["deepDetectionOpenPose"]["structure"],
                             **gpu_setting)
det_setting = config["deepModel"]["deepDetectionOpenPose"]["parameters"]
det_load_ret = my_trackModule.load_model(config["deepModel"]["deepDetectionOpenPose"]["model"])
