...
from .sort.detection import Detection, FaceDetection, PersonDetection
from .sort.tracker_single import Tracker as TrackerSingle

__all__ = ['DeepSort']


class DeepSort(object):
    def __init__(self, max_dist=0.2, single_mode=False,
                 min_confidence=0.3, nms_max_overlap=0.5,
                 nn_budget=100, *args, **kwargs):
        self.min_confidence = min_confidence
        self.nms_max_overlap = nms_max_overlap


        self.max_cosine_distance =0.2 #max_dist
        self.nn_budget =30 #nn_budget
    ...
    def get_output(self, res, img_size=(720, 1280, 3), *args, **kwargs):
