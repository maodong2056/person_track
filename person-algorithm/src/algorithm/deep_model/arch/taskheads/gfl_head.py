...
class GFLHead(AnchorHead):
    ...
    def __init__(self,
        ...
        self.loss_qfl = QualityFocalLoss(use_sigmoid=self.loss_cfg.loss_qfl.use_sigmoid,
    ...
    def loss(self,
        ...
        loss_states = {self.loss_cfg.loss_qfl.name: loss_qfl,
                       self.loss_cfg.loss_bbox.name: loss_bbox,
                       self.loss_cfg.loss_dfl.name: loss_dfl}
